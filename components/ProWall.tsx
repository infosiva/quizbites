...
export default function ProWall({ quizzesCompleted, score, total, onContinueFree, onNewQuiz }: ProWallProps) {
      ...
      >
        ...
        <div className={`${theme.card} p-6 text-center`}>
          ...
          <p className="text-white/50 text-sm mb-1">
            You&apos;ve completed <span className="text-white font-bold">{quizzesCompleted} quizzes</span> today!
          </p>
          <p className={`text-5xl font-black ${theme.textAccentBold}`}>
            {score}<span className="text-white/30 text-2xl">/{total}</span>
          </p>
        ...
        >
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-white font-black text-lg">Unlock QuizBites Pro</h2>
